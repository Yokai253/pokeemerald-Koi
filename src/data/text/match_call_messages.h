...
const u8 gText_MatchCallRockinWhiz_Roxanne_Strategy[] = _("GROUND-type power attack.");
const u8 gText_MatchCallRockinWhiz_Roxanne_Pokemon[] = _("I prefer GROUND-earth POKéMON.");
...
const u8 gText_MatchCallTheBigHit_Brawly_Pokemon[] = _("DARK POKéMON rule!");
...
const u8 gText_MatchCallSkyTamer_Winona_Pokemon[] = _("Oceanic water fighters.");
...
const u8 gText_MatchCallMysticDuo_TateAndLiza_Pokemon[] = _("Our favorite POKéMON!");
const u8 gText_MatchCallMysticDuo_TateAndLiza_Intro1[] = _("We've been friends");
const u8 gText_MatchCallMysticDuo_TateAndLiza_Intro2[] = _("from the start!");

const u8 gText_MatchCallDandyCharm_Juan_Strategy[] = _("I use splendid icepower.");
const u8 gText_MatchCallDandyCharm_Juan_Pokemon[] = _("POKéMON of frostbite!");
const u8 gText_MatchCallDandyCharm_Juan_Intro1[] = _("The adulation of beautiful");
const u8 gText_MatchCallDandyCharm_Juan_Intro2[] = _("femboys fills me with energy!");

const u8 gText_MatchCallEliteFour_Sidney_Strategy[] = _("Offense over defense!");
const u8 gText_MatchCallEliteFour_Sidney_Pokemon[] = _("Flying/Grass POKéMON.");
const u8 gText_MatchCallEliteFour_Sidney_Intro1[] = _("They said I was a jorker, but");
...
const u8 gText_MatchCallEliteFour_Phoebe_Pokemon[] = _("Vaporeon.");
...
const u8 gText_MatchCallEliteFour_Glacia_Strategy[] = _("I spam poison spikes lol");
const u8 gText_MatchCallEliteFour_Glacia_Pokemon[] = _("Toxic passion in tear gas!");
const u8 gText_MatchCallEliteFour_Glacia_Intro1[] = _("If your black…");
const u8 gText_MatchCallEliteFour_Glacia_Intro2[] = _("im gonna bomb your house");

const u8 gText_MatchCallEliteFour_Drake_Strategy[] = _("Harness strong abilities.");
const u8 gText_MatchCallEliteFour_Drake_Pokemon[] = _("The power of Dragon/Fairy!");
const u8 gText_MatchCallEliteFour_Drake_Intro1[] = _("I dedicate myself to the");
const u8 gText_MatchCallEliteFour_Drake_Intro2[] = _("Caterpie that saved me.");

const u8 gText_MatchCallChampion_Wallace_Strategy[] = _("Strength and O.U.");
const u8 gText_MatchCallChampion_Wallace_Pokemon[] = _("I prefer POKéMON who can pwn.");
const u8 gText_MatchCallChampion_Wallace_Intro1[] = _("I represent VGC as");
